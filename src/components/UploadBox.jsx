...
export default function UploadBox() {
  return (
    <div className="outline outline-2 outline-white/40 [outline-style:dashed] glass w-96 mx-auto my-10 p-5 border-2 border-dashed border-gray-600 rounded-xl text-center">
